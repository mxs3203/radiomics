...
ggplot(df_res %>% filter(adj_p_val < 0.06) , aes(x = t.estimate, y = -log10(t.p.value), label = g)) +
  geom_point() +
...
print(ggplot(df_res %>% filter(t.p.value < 0.06) , aes(x = t.estimate, y = -log10(t.p.value), label = g )) +
  geom_point() +
