...
for (par in c(vega_muts, cin_measures, "total.til.score.danahaer")){
    ...
    # , paste(features_of_interest, collapse="+"))
    ...
    df <- data.frame(response_var = tmp_$response, Prob = fit$finalModel$fitted.values)
