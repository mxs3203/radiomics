...
- In Adeno, big tumors with low radITH seem to perform the worst where small tumors with high radITH perform good(The same goes using radITH-Diameter split) \

- In Squmous we cannot see clear split(The same using radITH-diameter split) \
...
ggplot(df_res %>% filter(adj_p_val < 0.10), aes(x = hal, y = -log10(adj_p_val), color = t.estimate)) +
  geom_point() +
  ggtitle("Large Squmous tumors (median) \nssGSEA Hallmark correlation to radITH FDR adjusted pval")+
  ylab("-log10(Adj.P)")+
  theme_minimal() + 
  geom_hline(yintercept = -log10(0.05)) +
  theme(axis.text.x = element_text(angle = 90))
...
ggplot(df_res %>% filter(adj_p_val < 0.10) , aes(x = g, y = -log10(adj_p_val), color = t.estimate)) +
  geom_point() +
  ggtitle("Squamous Large Tumors: No significant corr after FDR")+
  ylab("-log10(Adj.P)")+
  theme_minimal() + 
  geom_hline(yintercept = -log10(0.05)) +
  theme(axis.text.x = element_text(angle = 90))
...
ggplot(df_res %>% filter(adj_p_val < 0.10) , aes(x = g, y = -log10(adj_p_val), color = t.estimate)) +
  geom_point() +
  ggtitle("Squamous Small Tumors: No significant corr after FDR")+
  ylab("-log10(Adj.P)")+
  theme_minimal() + 
  geom_hline(yintercept = -log10(0.05)) +
  theme(axis.text.x = element_text(angle = 90))
...
ggplot(df_res %>% filter(adj_p_val < 0.06) , aes(x = g, y = -log10(adj_p_val), color = t.estimate)) +
  geom_point() +
  ggtitle("Adeno Large Tumors(median): No significant corr after FDR")+
  ylab("-log10(Adj.P)")+
  theme_minimal() + 
  geom_hline(yintercept = -log10(0.05)) +
  theme(axis.text.x = element_text(angle = 90))
...
ggplot(df_res %>% filter(adj_p_val < 0.06) , aes(x = g, y = -log10(adj_p_val), color = t.estimate)) +
  geom_point() +
  ggtitle("Adeno Small Tumors(median): No significant corr after FDR")+
  ylab("-log10(Adj.P)")+
  theme_minimal() + 
  geom_hline(yintercept = -log10(0.05)) +
  theme(axis.text.x = element_text(angle = 90))
